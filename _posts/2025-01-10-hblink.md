...
Alternatively, you can bridge the two timeslots for both the parrot and your private talkgroup, so that radios coming in on either time slot will go out over the others.  
...
BRIDGES = {
    ...
    # Parrot: TG 9999 on both slots. Include the PARROT peer so it hears (and replies to) either slot.
    'PARROT': [
